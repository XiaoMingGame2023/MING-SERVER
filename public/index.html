...
<html lang="Zh-CN">
  ...
  <body>
    ...
    <header id="header-wrap">
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          <!-- 网站头部LOGO -->
          <!-- logo尺寸为400*60透明底或350*60透明底，其实就是宽度就是60别太大其他好像都没啥问题-->
          <a href="index.html" class="navbar-brand"><img src="assets/img/logo1.png " alt="MING SERVER我的世界服务器"></a>       
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end clearfix">
              ...
              <li class="nav-item">
                <a class="nav-link" href="gonggao.html">
                  公告
                </a>
               <li class="nav-item">
                <a class="nav-link" href="zx.php">
                  服务器状态
                </a>
              </li>
            </ul>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="contents text-center">
                <!-- 标题内容修改 -->
                <h2 class="head-title wow fadeInUp">欢迎您来到MIBF-PE生存服务器! <br> 本服务器由MING SERVER团队运营</h2>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="text-wrapper">
              <div>
                <h2 class="title-hl wow fadeInLeft" data-wow-delay="0.3s">赶快加入我们吧！ <br> 我在MING SERVER等候您的到来！</h2>
    ...
    <section id="services" class="section-padding bg-gray">
      <div class="container">
        <div class="section-header text-center">
          ...
          <p>服务器特色，这是属于我们MING SERVER的特色，赶快加入服务器吧！</p>
        </div>
        <div class="row">
          <!-- 此处内容自定义修改 -->
          <!-- 开始 -->
          <div class="col-md-6 col-lg-4 col-xs-12">
            <div class="services-item wow fadeInRight" data-wow-delay="0.3s">
              ...
              <div class="services-content">
                <h3><a href="#">纯净的生存系统</a></h3>
                <p>我们服务器采用原生态纯净生存，无任何超辅助类插件及功能插件！</p>
              </div>
            </div>
          </div>
          <!-- 结束 -->
          <!-- 如需增加复制开始至结束内的内容，在后方粘贴即可 -->
          <!-- 此处内容自定义修改 -->
          <div class="col-md-6 col-lg-4 col-xs-12">
            <div class="services-item wow fadeInRight" data-wow-delay="1.2s">
              ...
              <div class="services-content">
                <h3><a href="#">IOS & 安卓 & WIN三端互通</a></h3>
                <p>我们支持IOS & 安卓 & WIN三端互通，为更多的玩家提供服务！</p>
              </div>
            </div>
          </div>
        </div>
 ...
 <!-- 一些话 -->
 <!-- 修改开服时间到文件夹static/js/time.js内修改 -->
   <section id="services" class="section-padding bg-gray">
      <div class="container">
        <div class="section-header text-center">
            <style type="text/css">
  ...
  <!-- 修改上面的20px可以更改字体大小 -->
                ...
                <p id="p1">这是一段话可以自己修改</p> -->
                <p id="p1">目前已走过<span style="color: red;" id="time"></span>。</p>
                <span style="color: black;">
                <!-- <p id="p1">这是一段话可以自己修改</p>
                <p id="p1">这是一段话可以自己修改</p>
                <p id="p1">这是一段话可以自己修改</p>
          ...
          <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="contact-right-area wow fadeIn">
              <div class="contact-title">
                <h1>尊敬的玩家先生、小姐：</h1>
                <p>赶快通过下面的方式加入我们吧！我们在MING SERVER等您的到来！</p>
              </div>
              <h2>联系我们</h2>
              <div class="contact-right">
                <div class="single-contact">
                  ...
                  <p>官方玩家QQ交流群: 971379270</p>
                </div>
                <div class="single-contact">
                  <div class="contact-icon">
                    <i class="lni-envelope"></i>
                  </div>
                  <p><a href="#">意见投稿邮箱: MING@wuliya.top</a></p>
                </div>
                <div class="single-contact">
                  <div class="contact-icon">
